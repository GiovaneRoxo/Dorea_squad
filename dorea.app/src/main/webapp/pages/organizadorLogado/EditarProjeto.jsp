...
<div class="container main-tamanho">
	<div class="row">
		...
		<hr>
		<form name="editarProjeto" action="${pageContext.request.contextPath}/editar" method="post">
			...
			<div class="form-floating mb-3">
				<input id="objetivo" name="objetivo" required maxlength="18" type="number" step="0.01" min="0.01" class="form-control" onkeyup="somenteNumeros(this);" value="${projeto.objetivo}"> 
