...
<head>
	<meta charset="UTF-8">
	<title>Doreá | Minhas Doações</title>
...
<div class="container main-tamanho">
	<div class="row">
		...
		<hr>
		<%int i = 0; %>
		<c:forEach items="${doacoes}" var="doacoes">
			<div class="row pb-3">
				<div class="d-flex justify-content-start">
					<p class=" mb-1">Doação <%out.print(i=i+1); %></p>
				</div>
				<div class="col">
				  <label class="ps-2 pb-1">Valor</label>
		          <input class="form-control" value="${doacoes.valor}" readonly="true">
		        </div>
		        <div class="col">
		          <label class="ps-2 pb-1">Id Doador</label>
		          <input class="form-control" value="${doacoes.fk_Doadores_Id_doadores}" readonly="true">
		        </div>
		        <div class="col">
		          <label class="ps-2 pb-1">Id Projeto</label>
		          <input class="form-control" value="${doacoes.fk_Projetos_Id_projeto}" readonly="true">
		        </div>
			</div>
	    </c:forEach>
		</div>
